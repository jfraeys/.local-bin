...
[![GitHub Workflow Status](https://img.shields.io/github/workflow/status/jfraeys/.local-bin/pages-build-deployment?label=Build&logo=github&style=for-the-badge)](https://github.com/jfraeys/.local-bin/actions/workflows/pages/pages-build-deployment)
