...
[![GitHub Workflow Status](https://github.com/jfraeys/.local-bin/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/jfraeys/.local-bin/actions/workflows/pages-build-deployment)
